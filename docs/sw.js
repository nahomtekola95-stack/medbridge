...
const CACHE = "medbridge-v12";
const ASSETS = ["./", "./index.html", "./css/style.css", "./js/config.js", "./js/books.js", "./js/drugs-data.js", "./js/conditions.js", "./js/profiles.js", "./js/calc.js", "./js/api.js", "./js/community.js", "./js/app.js", "./manifest.json", "./icons/icon.svg", "./icons/icon-192.png", "./icons/icon-512.png"];
