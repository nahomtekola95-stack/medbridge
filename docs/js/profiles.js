...
/* ---------------------------------------------------------- */
{
  ...
  procedures: [
    ...
    { title: "Oxygen concentrators", level: "Health centre and above", text: "Concentrators (5–10 L/min) with nasal prongs are the main oxygen source; keep a cylinder backup for power cuts; check SpO2 target ≥ 90 %. To share one concentrator, use a flowmeter stand with a separate flowmeter for each child; a plain Y-connector splits the flow unevenly." },
