...
(function () {
  ...
  const AM = {
    ...
    /* ---- PPH first response ---- */
    "PPH first response": "የወሊድ ደም መፍሰስ የመጀመሪያ ምላሽ",
    "Measured blood loss, the six-part bundle on a 15-minute clock, and the tranexamic acid window.": "የተለካ የደም መፍሰስ፣ በ15 ደቂቃ ውስጥ የሚሰጠው ስድስት ክፍል ያለው ጥምር ሕክምና እና የትራኔክሳሚክ አሲድ የጊዜ ገደብ።",
    "Measure the blood loss, and give the whole bundle within 15 minutes. Do not work down the list one drug at a time.": "የደም መፍሰሱን ይለኩ፤ ሙሉውን ጥምር ሕክምና በ15 ደቂቃ ውስጥ ይስጡ። አንድ በአንድ መድኃኒት እየሞከሩ አይዘግዩ።",
    "Time of birth": "የተወለደችበት ሰዓት", "Just now": "አሁን", "New woman": "አዲስ እናት", "Handover": "ርክክብ",
    "The tranexamic acid window runs 3 hours from the birth, so this is the clock that matters.": "የትራኔክሳሚክ አሲድ የጊዜ ገደብ ከወሊድ ጀምሮ 3 ሰዓት ነው፤ ስለዚህ ወሳኙ ሰዓት ይህ ነው።",
    "Measured blood loss": "የተለካ የደም መፍሰስ", "Observations": "የሕይወት ምልክቶች", "Undo last": "የመጨረሻውን ሰርዝ", "Add": "ጨምር",
    "Read it off the calibrated drape. Looking at the bed and guessing under-reads badly — that is why PPH gets caught late.": "ከተለካ ድሬፕ ላይ ያንብቡት። አልጋውን እያዩ መገመት ከትክክለኛው በጣም ያንሳል — የወሊድ ደም መፍሰስ ዘግይቶ የሚያዘው በዚህ ምክንያት ነው።",
    "Pulse 110 or more": "የልብ ምት 110 እና ከዚያ በላይ", "Systolic BP under 90 mmHg": "የላይኛው የደም ግፊት ከ90 mmHg በታች",
    "Pale, clammy, faint, confused or breathless": "መገርጣት፣ ላብ፣ መዛል፣ መደናገር ወይም የትንፋሽ ማጠር",
    "Uterus soft or boggy on palpation": "ማሕፀኑ ሲዳሰስ ለስላሳ ሆኖ መገኘት", "Bleeding still running, not slowing": "ደሙ ሳይቀንስ መፍሰሱን መቀጠል",
    "The bundle — all six, together": "ጥምር ሕክምናው — ስድስቱም አንድ ላይ",
    "Uterine massage": "የማሕፀን ማሸት", "Oxytocic drug": "የማሕፀን ማስኮማተሪያ መድኃኒት", "Tranexamic acid": "ትራኔክሳሚክ አሲድ",
    "IV fluids": "የደም ስር ፈሳሽ", "Examine the genital tract": "የመውለጃ ቦይን መመርመር", "Escalate": "ወደ ላይ ማሳወቅ",
    "Still bleeding after the bundle": "ከጥምር ሕክምናው በኋላም ደሙ ካልቆመ",
    "Refractory PPH. Do these while someone else arranges theatre, blood and transport.": "የማይገታ የወሊድ ደም መፍሰስ። ሌላ ሰው ኦፕራሲዮን፣ ደም እና መጓጓዣ እያዘጋጀ እርስዎ እነዚህን ያድርጉ።",
    "Bimanual uterine compression": "በሁለት እጅ ማሕፀንን መጭመቅ", "External aortic compression": "ከሆድ ውጭ ዋናውን የደም ቧንቧ መጫን",
    "Uterine balloon tamponade": "በፊኛ ማሕፀንን መጫን", "Non-pneumatic anti-shock garment": "የፀረ-ሾክ ልብስ", "Theatre": "ኦፕራሲዮን", "Refer": "ሪፈር ማድረግ",
    "Full PPH case": "ሙሉ የወሊድ ደም መፍሰስ መመሪያ", "Emergency doses": "የአስቸኳይ ጊዜ መጠኖች",
    "Clear this record and start a new woman?": "ይህን መዝገብ አጥፍቼ በአዲስ እናት ልጀምር?",
    "Enter the measured volume in mL.": "የተለካውን መጠን በ mL ያስገቡ።",
    "Enter the time of birth to start the 3-hour window.": "የ3 ሰዓቱን ገደብ ለመጀመር የተወለደችበትን ሰዓት ያስገቡ።",
    "Record the first dose now": "የመጀመሪያውን መጠን አሁን መዝግብ",
