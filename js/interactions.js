...
window.INTERACTIONS = [
  ...
  {a: ["quetiapine"],b: ["amiodarone","quinine"],severity: "major",effect: "Additive QT prolongation: risk of torsades de pointes and sudden death, worse with low potassium or magnesium or a slow pulse.",action: "Avoid combining (Kaplan). Prefer artesunate for severe malaria. If unavoidable, lowest quetiapine dose, correct potassium and magnesium, ECG before and during treatment where possible, and ask about fainting and palpitations.",ref: "Kaplan & Sadock 12th ed. 2022, ch. 21.1, pdf p. 1937"},
